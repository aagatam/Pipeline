...
writeLines(list_BN, paste(spl_path,'/BN_common_genes.txt',sep=''))
...
writeLines(list_BK, paste(spl_path,'/BK_common_genes.txt',sep=''))
...
writeLines(list_NAO, paste(spl_path,'/NaO_common_genes.txt',sep=''))
...
for (event in c('alt_3_prime','alt_5_prime','exon_skip','mult_exon_skip','mutex_exons'))
{
  for (type in c('both_new','both_known','newAndOld'))
  {
    ...
    for (method in c('CC','MF','BP'))
    {
      ...
      write.csv(allRes[,c(1,2,6,7)],paste(spl_path,'/',event,'_',type,'_',th_GO,'_',method,'.csv',sep=''))
...
writeLines(BP_BK_i, paste(spl_path,'/BP_BK_common.txt',sep=''))
...
writeLines(CC_BK_i, paste(spl_path,'/CC_BK_common.txt',sep=''))
...
writeLines(MF_BK_i, paste(spl_path,'/MF_BK_common.txt',sep=''))
...
writeLines(BP_BN_i, paste(spl_path,'/BP_BN_common.txt',sep=''))
...
writeLines(CC_BN_i, paste(spl_path,'/CC_BN_common.txt',sep=''))
...
writeLines(MF_BN_i, paste(spl_path,'/MF_BN_common.txt',sep=''))
...
writeLines(BP_ON_i, paste(spl_path,'/BP_ON_common.txt',sep=''))
...
writeLines(CC_ON_i, paste(spl_path,'/CC_ON_common.txt',sep=''))
...
writeLines(MF_ON_i, paste(spl_path,'/MF_ON_common.txt',sep=''))
