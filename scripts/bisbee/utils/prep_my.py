...
events_file='merge_graphs_mult_exon_skip_C3.counts.hdf5'
events_type='MULT'
outname='MUT_otput' + '.bisbeeCounts.csv'
spladder_ver=2
if len(sys.argv)>5:
...
event_dict={'A3':'alt_3prime','A5':'alt_5prime','ES':'exon_skip','IR':'intron_retention','MUT':'mutex_exons','MULT':'mult_exon_skip'}
