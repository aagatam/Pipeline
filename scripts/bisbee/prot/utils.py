...
def find_seq_diff(seq1,seq2):
 ...
 if len(align_list)==0:
  ...
  seq_comp=seq_comp.assign(seq1_pos= seq_comp.seq1.isin(list('ACDEFGHIKLMNPQRSTVWY')).cumsum())
  seq_comp=seq_comp.assign(seq2_pos= seq_comp.seq2.isin(list('ACDEFGHIKLMNPQRSTVWY')).cumsum())
