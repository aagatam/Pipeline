...
packages<-c("knitr","dplyr","yaml","data.table","seqinr","stringr","gsubfun","reticulate")
...
BAM_file<- "/bi/ala/scratch/amuszynska/Rasflow/Output_GRCm39/Pain_new_genome/genome/bamFileSort/out.bam"
